...
cat(" <br/> <br/>")
cat("\n")
cat("Having trouble seeing the graphs? You may need to allow your browser to load unauthenticated scripts from unsafe sources to enable the graphs to load properly.") 
cat("\n")
cat(" <br/> <br/>")
