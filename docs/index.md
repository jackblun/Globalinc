...
![image-right](/img/core-logo-red.png){: .align-right}

![image-right](/img/core-logo-red.png){:class="img-responsive" height="50%" width="50%" .align-right }](http://www.core-econ.org/)
